...
difference() {
	...
	union() {
		translate(v = [-82.5000000000, -75.0000000000, 2]) {
			rotate(a = [0, 0, 0]) {
				difference() {
					union() {
		...
		translate(v = [0, 0, 3]) {
			hull() {
				union() {
					translate(v = [-84.5000000000, 77.0000000000, 4]) {
						cylinder(h = 30, r = 4);
					}
					translate(v = [-84.5000000000, 77.0000000000, 4]) {
						sphere(r = 4);
					}
					translate(v = [-84.5000000000, 77.0000000000, 34]) {
						sphere(r = 4);
					}
				}
				union() {
		...
		translate(v = [-105.0000000000, -75.0000000000, 22.5000000000]) {
			rotate(a = [0, 90, 0]) {
